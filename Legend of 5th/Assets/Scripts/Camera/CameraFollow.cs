...
public class CameraFollow : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        target = new Vector3(
            Mathf.Round(player.transform.position.x / screenLengthX) * screenLengthX, 
            Mathf.Round(player.transform.position.y / screenLengthY) * screenLengthY, 
        0);
